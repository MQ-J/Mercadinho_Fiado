...
<% pageContext.setAttribute("localDateTimeFormatId", DateTimeFormatter.ofPattern("dd-MM-yyyy-HH-mm")); %>
			...
			<li class="list-group-item d-flex justify-content-between align-items-center">
				...
				<c:forEach items="${pagamentos.compras}" var="compras">
					...
					<div class="d-flex gap-3">
						<a type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editaPagamento${localDateTimeFormatId.format(pagamentos.dataPagto)}">
							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
								<path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"></path>
								<path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"></path>
							</svg>
						</a>
						<a type="button" class="btn btn-outline-danger" href="/fiado/pagamentos/altera?id=${compras.idCompra}&valor=${pagamentos.valorPago}">
					...
					<div class="modal fade" id="editaPagamento${localDateTimeFormatId.format(pagamentos.dataPagto)}" tabindex="-1" aria-labelledby="modal de novo pagamento" aria-hidden="true">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="/fiado/pagamentos/altera" method="post">
									<div class="mb-3">
										<label for="valor" class="form-label">valor pago</label>
										<input type="number" step="0.01" class="form-control" id="valor" name="valor" min="0.01" value="${pagamentos.valorPago}">
									</div>
									<div class="mb-3">
										<label for="idcompra" class="form-label">ID da compra referente</label>
										<input type="number" class="form-control" id="idcompra" name="idcompra" min="1" value="${compras.idCompra}">
									</div>

									<input type="number" class="form-control" id="idcompraOld" name="idcompraOld" min="1" value="${compras.idCompra}" hidden>
									<input type="number" step="0.01" class="form-control" id="valorOld" name="valorOld" min="0.01" value="${pagamentos.valorPago}" hidden>
